...
in some cases where the Simulation period is set to a small value, the simulation can not give an answer as the threshold triggering time may be longer than the simulation time period"""
